package com.example.tazin.weatherapplication;
...
import important.AlarmReceiver;
import important.Constants;
import adapters.ViewPagerAdapter;
import models.Weather;
import tasks.GenericRequestTask;
import tasks.ParseResult;
import tasks.TaskOutput;
import utils.UnitConvertor;
import widgets.AbstractWidgetProvider;
import widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayTemperature = (CircleView) findViewById(R.id.todayTemperature);
    ...
    private void updateTodayWeatherUI() {
        ...
        todayTemperature.setTitleText(new DecimalFormat("0.#").format(temperature) + " " + sp.getString("unit", "°C"));
